...
CREATE TABLE "CommentComment" (
  "CommentId" int8 NOT NULL,
  "ReplyToCommentId" int8 NOT NULL,
  PRIMARY KEY ("CommentId", "ReplyToCommentId")
);

CREATE TABLE "CommentPost" (
  "CommentId" int8 NOT NULL,
  "ReplyToPostId" int8 NOT NULL,
  PRIMARY KEY ("CommentId", "ReplyToPostId")
);

ALTER TABLE "CommentComment" ADD FOREIGN KEY ("CommentId") REFERENCES "Comment" ("Id");

ALTER TABLE "CommentComment" ADD FOREIGN KEY ("ReplyToCommentId") REFERENCES "Comment" ("Id");

ALTER TABLE "CommentPost" ADD FOREIGN KEY ("CommentId") REFERENCES "Comment" ("Id");

ALTER TABLE "CommentPost" ADD FOREIGN KEY ("ReplyToPostId") REFERENCES "Post" ("Id");
